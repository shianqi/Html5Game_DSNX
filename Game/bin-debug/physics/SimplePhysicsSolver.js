...
(function (physics) {
    var SimplePhysicsSolver = (function () {
        ...
        var d = __define,c=SimplePhysicsSolver;p=c.prototype;
        /**
        ...
        p.overlapOnce = function (a, b) {
            var overlap = (a.x + a.width / 2 >= b.x - b.width / 2 && a.x - a.width / 2 <= b.x + b.width / 2 && a.y + a.height / 2 >= b.y - b.height / 2 && a.y - a.height / 2 <= b.y + b.height / 2); // y axis overlaps
            if (overlap) {
    ...
    egret.registerClass(SimplePhysicsSolver,"physics.SimplePhysicsSolver");
})(physics || (physics = {}));
